...
2. Search for nautilus-vm.
3. Under Availability + Scale, click on size.
4. Click on Standard_B2s and click on resize.
   <img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/c88f9599-aa57-4e2e-9407-9d2c0ac9958a" />
5. Ensure the vm is in running state after resize.
   ![Uploading image.png…]()
